...
export default function CompetitionsPage() {
  ...
  const levels = [
    ...
    },
    {
      ...
      duration: "2 Hours",
      fee: "Free (Qualified)",
      desc: "Competitors who clear the school round face tougher challenges here. The introduction of oral rounds begins, testing their verbal command of spelling.",
      details: [
        "Advanced written spelling test",
        "Live oral spelling before judges",
    ...
    },
    {
      ...
      details: [
        ...
        "Words from advanced academic corpus",
        "On-stage performance judged by panel",
        "Top 10 advance to National Finale",
      ],
    },
    {
      id: 3,
