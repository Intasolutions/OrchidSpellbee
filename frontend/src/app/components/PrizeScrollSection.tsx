...
const prizes = [
  ...
  },
  {
    ...
    includesTextbook: true,
    data: [
      { rank: "1ST PRIZE:", detail: "Rs. 5000 + MEMENTO + CERTIFICATE" },
      { rank: "2ND PRIZE:", detail: "Rs. 3000 + MEMENTO + CERTIFICATE" },
      { rank: "3RD PRIZE:", detail: "Rs. 1500 + MEMENTO + CERTIFICATE" },
      { rank: "4TH PRIZE:", detail: "Rs. 1000 + MEMENTO + CERTIFICATE" },
      { rank: "5TH PRIZE:", detail: "Rs. 750 + MEMENTO + CERTIFICATE" },
      { rank: "6TH - 10TH PRIZE:", detail: "Rs. 500 + MEMENTO + CERTIFICATE" },
    ],
  },
  {
    level: "State Level",
    ...
    includesTextbook: true,
    data: [
      { rank: "1ST PRIZE:", detail: "Rs. 15000 + MEMENTO + CERTIFICATE" },
      { rank: "2ND PRIZE:", detail: "Rs. 10000 + MEMENTO + CERTIFICATE" },
      { rank: "3RD PRIZE:", detail: "Rs. 5000 + MEMENTO + CERTIFICATE" },
      { rank: "4TH PRIZE:", detail: "Rs. 3000 + MEMENTO + CERTIFICATE" },
      { rank: "5TH PRIZE:", detail: "Rs. 2000 + MEMENTO + CERTIFICATE" },
      { rank: "6TH - 10TH PRIZE:", detail: "Rs. 1000 + MEMENTO + CERTIFICATE" },
    ],
  },
  {
